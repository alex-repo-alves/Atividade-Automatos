...
public class Q2d {
    ...
    public static void main(String[] args) {
        Q2d automato = new Q2d(); //Instancia o automato
        String sentenca[] = {"ac", "bac", "a", "aabbac", "abc", "bc"}; //array com as palavras de teste
    ...
    public void q1() {
        if (cont < palavra.length) { //verifica se já está no final da cadeia de char
            if (palavra[cont] == 'a') { //teste pra mudar de estado
                ...
                cont++;
                q0();
            } else if (palavra[cont] == 'c') { //teste pra mudar de estado
                cont++;
                q2();
            } else {
                qErro();//não pertence ao vocabulário?
    ...
    public void q2() {
        if (cont < palavra.length) { //verifica se já está no final da cadeia de char
            if (palavra[cont] == 'c') { //teste pra mudar de estado
                cont++;
                q2(); //muda de estado
            } else {
                qErro();
